...
- New layers (e.g., persistence, alternative UIs) should be added as separate directories/namespaces alongside `domain/` and `fix_cli/`, never inside the domain layer.
